    ...
    return (
        ...
        <div className="data_box">
            <div className="data">
                ...
                <p className="sub_tit">제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)</p>
                <p className="txt">
        ...
        <div className="chk_box">
            ...
            <label htmlFor="agree01"><span></span><p>동의합니다.</p></label>
        </div>
        <strong>개인정보처리방침</strong>
        <div className="data_box">
            <div className="data">
                <p className="txt">('www.project.com'이하 '제일종합관리서비스(주)')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.	<br/><br/>
                ...
                <p className="txt"> ('www.project.com'이하 '제일종합관리서비스(주)')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br/>
                    가. 홈페이지 회원가입 및 관리<br/>
                ...
                <p className="txt">1. 개인정보 파일명 : 개인정보처리<br/>	
                    - 개인정보 항목 : 문의시 받음<br/>
                    - 수집방법 : 홈페이지<br/>
                    - 보유근거 : 정보주체의 동의<br/>	
                    - 보유기간 : 3년<br/>
                ...
                <p className="txt">① ('제일종합관리서비스(주)')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.<br/>
                ...
                <p className="sub_tit">4. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.</p>
                <p className="txt">
                ...
                <p className="txt">① ('www.project.com'이하 '제일종합관리서비스(주)')은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br/>	
                <br/>
                ...
                <p className="sub_tit">6. 개인정보의 파기('제일종합관리서비스(주)')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.</p>
                <p className="txt">-파기절차<br/>
                ...
                <p className="sub_tit">7. 개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항</p>
                <p className="txt">제일종합관리서비스(주) 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.</p>
                ...
                <p className="txt">① 제일종합관리서비스(주)(‘www.project.com’이하 ‘제일종합관리서비스(주)) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.		<br/>	
                    ▶ 개인정보 보호책임자<br/>
                    성명 : 김돈<br/>
                    직급 : 대표<br/>
                    연락처 : 1877-3855<br/>
                ...
                <p className="sub_tit">10. 개인정보의 안전성 확보 조치 ('제일종합관리서비스(주)')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</p>



                <p className="txt">1. 정기적인 자체 감사 실시<br/>	
        ...
        <div className="chk_box">
            ...
            <label htmlFor="agree02"><span></span><p>동의합니다.</p></label>
        </div>
    </form>
    )
}
