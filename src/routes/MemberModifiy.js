      ...
      <div className="infoModi">
        ...
        >
            ...
            <div className="row post_address">
              ...
              <div className="input_box id">
                ...
                <input
                  ...
                  id="strAddr2"
                  maxLength="200"
                  value={users[0].address.suite}
                />
              </div>
            </div>
            <div className="row join_phone">
              <label htmlFor="write_phone" className="label input_height">
                연락처 *
              </label>
          ...
          <div className="btn_box">
            <div>
              <button type="button" className="btn_ok" onClick={onClickBtn}>
                수정완료
              </button>
            </div>
          </div>
